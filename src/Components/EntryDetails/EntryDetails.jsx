  ...
  return (
    ...
    <div className="bg-customWhite my-5 mx-20 shadow-[0_3px_12px_rgba(0,0,0,0.1)]">
      <div className="flex flex-col py-10 px-20">
        ...
        />
        <h2 className="font-bold mb-5 pl-6 mt-11">Profile Image</h2>
        <input
          type="file"
          accept="image/*"
        ...
        <div className="flex items-center pl-6 mt-11 mb-5">
          ...
          <span className="ml-2">(Choose up to 5 skills)</span>
        </div>
        <div>
          <select
            name="skill"
        ...
        <div className="mx-auto mt-20 flex flex-row space-x-9">
          <button
            type="button"
