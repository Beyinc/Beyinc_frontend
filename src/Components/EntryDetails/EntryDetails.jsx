...
//                   <div
//                     onClick={() => toggleIndustry(industry)}
//                     className="flex justify-between p-4 cursor-pointer border border-gray-400"
//                   >
...
//             <button
//               className="bg-blue-600 text-white px-6 py-2 rounded w-[100px]"
//               onClick={() => {
//                 setStep(2);
//                 setSelectedExpertise({});
//                 setCompanyStage("");
...
//             <button
//               className="bg-blue-600 text-white px-6 py-2 rounded w-[100px] disabled:opacity-50"
//               onClick={handleSubmit}
...
const EntryDetails = () => {
  ...
  const totalSteps =
    selectedCategory === "Mentor" || selectedCategory === "Startup" ? 3 : 2;
