...
const Post = ({ post, setAllPosts }) => {
  ...
  const handleClickOutside = (event) => {
    if (
      ...
      document.getElementsByClassName(`postSubActions${post?._id}`)[0]?.classList.remove('show')
      ...
      <div className='ProfilepostContainer'>
        <div className='PostHeaderContainer'>
          <div className='postTotaldetails'>
            <div className='PostheaderimageContainer'>
              <img src={post?.createdBy?.image !== "" && post?.createdBy?.image !== undefined && post?.createdBy?.image?.url !== ''
                ? post?.createdBy?.image?.url
                : "/profile.png"} alt="" />
            </div>
            <div className='PostDetailsContainer'>
              <div className='postCardUserName'>{post?.createdBy?.userName[0]?.toUpperCase() + post?.createdBy?.userName?.slice(1)}</div>
        ...
        <div className='postDescContainer'>
          ...
          <div className='PostimageContainer'>
            <img src={post?.image !== "" && post?.image !== undefined && post?.image?.url !== ''
              ? post?.image?.url
              : "/profile.png"} alt="" />
          </div>
 ...
 />
        ...
        <EditPost EditPostCount={EditPostCount} setEditPostpopup={setEditPostpopup} editPostPopup={editPostPopup} post={post} setAllPosts={setAllPosts} />
