...
const IndividualPostDetailsCard = () => {
  ...
  // Missing state from origin for consistency (editPostCount used in origin? optional)
  const [editPostPopup, setEditPostPopup] = useState(false);
  const [editPostCount, setEditPostCount] = useState(0);
        ...
        <div className="post-details-container">
          <div className="post-details-content-left grow">
            <div style={{ position: "relative" }}>
              {/* Header Structure from Origin (Enhanced) */}
              <div className="PostHeaderContainer" style={{ flexDirection: "column" }} >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", width: "100%", alignItems: "flex-start" }}>
                  ...
                  {/* RIGHT SIDE: Menu Only - Hidden for unauthenticated users */}
                  {user_id && (
                    <div style={{ position: "relative" }}>
                      <div
            ...
            <div className="postDescContainer">
              ...
              {/* Full Details with Logic from Origin */}
                      ...
                      {(post?.openDiscussion === true ||
                        ...
                        role === "Admin") && (
                          <div
                            className="viewPitch"
                            onClick={() =>
                              navigate(`/livePitches/${post?.pitchId?._id}`)
                            }
                          >
                            View Pitch
                          </div>
