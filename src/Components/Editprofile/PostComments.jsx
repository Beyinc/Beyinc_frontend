    ...
    <div className="">
      <div className="postCommentAddSection">
        <div style={{display:'flex', flexDirection: 'row'}}>
          ...
          <div className="CommentPostContainer" style={{ display: "flex", gap: "20px", alignItems: "flex-end" }}>
            <div style={{ position: "relative", width: "100%" }}>
              ...
              {selectedFile && (
                <div style={{ 
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontSize: '14px', color: '#333' }}>{selectedFile.name}</div>
              ...
              {/* Pin button for file attachment */}
              <div
              ...
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                style={{
                  cursor: comment === "" && !selectedFile ? "not-allowed" : "pointer",
                  padding: "10px",
                  position: "absolute",
                  right: "0px",
                  top: "6px",
