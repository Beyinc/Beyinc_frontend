...
const Posts = () => {
  ...
  // Only fetch dashboard details for authenticated users
  useEffect(() => {
    if (isAuthenticated) {
  ...
  // Only fetch recommended users for authenticated users
  useEffect(() => {
  ...
  }, [recommendedUserTrigger, isAuthenticated, user_id]);
  ...
  }, [recommendedUserTrigger, user_id, isAuthenticated]);
      ...
      >
        ...
        <div className="sidebar-menu shadow-lg">
          {isAuthenticated ? (
            ...
            // Guest user sidebar - show sign up/login prompts
            <>
              <div className="Homepage-left-container-profile">
                <div>
                  <img
                ...
                <div>
                  ...
                  <div style={{ fontSize: "12px" }}>Sign up to interact</div>
                </div>
              </div>
              <div
                className="sidebar-menu-items"
              ...
              >
                <div>
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4s-4 1.79-4 4s1.79 4 4 4m0-6c1.1 0 2 .9 2 2s-.9 2-2 2s-2-.9-2-2s.9-2 2-2m0 7c-2.67 0-8 1.34-8 4v3h16v-3c0-2.66-5.33-4-8-4m6 5H6v-.99c.2-.72 3.3-2.01 6-2.01s5.8 1.29 6 2z"
                    />
                  </svg>
                </div>
                <div>Login</div>
