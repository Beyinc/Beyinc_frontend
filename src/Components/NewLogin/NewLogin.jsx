...
function NewLogin() {
  ...
  return (
    ...
    <div className="login-bg-wrapper flex justify-center items-center">

    <div className="relative flex flex-row bg-[#FFFFFF] h-[850px] w-[1180px] max-h-[900px] mt-5 shadow-lg rounded-[20px] main-outer-div mb-10">
      {/* Logo top-right */}
      <img
