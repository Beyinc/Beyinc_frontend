...
export const domain_subdomain = {
  ...
  "Food & Beverage": ["Food", "Beverage", "Alcohol", "Nutrition", "Organic"],
  ...
  Media: ["Publishing", "Radio", "Film", "TV", "Music"],
  "Medical & Services": [
    "MedTech",
    "Healthcare",
    "Pharma",
  ...
  Retail: ["Retail", "FMCG", "Shop", "Consumer", "Wholesale"],
  "Sales & Marketing": [
    "Marketing",
    "Sales",
    "PR",
  ...
  Software: ["Software", "Ecommerce", "Apps", "Data", "SaaS", "Gaming", "Web"],
  Technology: [
    "Technology",
    "Robotics",
    "IT Hardware",
...
export const allsalutations = ["Dr", "Mr", "Mrs", "Miss"];

export const mentorcategories = ["Academia Mentor", "Industry Expert Mentor "];
...
export const convertToDate = (inputDate) => {
  ...
  const date =
    inputDate?.split("-")[1][0] == "0"
      ? inputDate?.split("-")[1][1] - 1
      : inputDate?.split("-")[1] - 1;
...
export const followerController = async ({
  ...
  if (setRecommendedUsers) {
    setRecommendedUsers((prev) =>
      Array.isArray(prev) ? prev.filter((u) => u._id !== followingToId) : prev,
    );
  }
...
export function convertCamelToNormalCapitalized(camelCaseString) {
